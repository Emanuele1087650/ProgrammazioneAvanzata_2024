...
class ErrorFactory {
  private static errorMap: Record<ErrorType, ErrorResponse> = {
    ...
    [ErrorType.BAD_REQUEST]: {
      code: HttpStatusCode.BAD_REQUEST,
      name: ErrorType[ErrorType.BAD_REQUEST],
    ...
    [ErrorType.INVALID_IMPORT]: {
      code: HttpStatusCode.BAD_REQUEST,
      name: ErrorType[ErrorType.INVALID_IMPORT],
      message: Messages.INVALID_IMPORT,
    },
    [ErrorType.RECHARGE_FAIL]: {
      code: HttpStatusCode.BAD_REQUEST,
      name: ErrorType[ErrorType.RECHARGE_FAIL],
      message: Messages.RECHARGE_FAIL,
    },
    ...
    [ErrorType.INFERENCE_ABORTED]: {
      code: HttpStatusCode.BAD_REQUEST,
      name: ErrorType[ErrorType.INFERENCE_ABORTED],
      message: Messages.INFERENCE_ABORTED,
    },
